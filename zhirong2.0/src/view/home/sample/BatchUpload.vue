  ...
  data () {
    return {
      copyDatas: [
        {
          name: 'FTP共享目录地址',
          content: 'ftp://' + (localStorage.tokenName === 'gtd' ? '192.168.5.31' : window.location.hostname),
          secret: 'ftp://' + (localStorage.tokenName === 'gtd' ? '192.168.5.31' : window.location.hostname)
        },
        {
          name: '用户名',
          content: 'ftp',
