  ...
  <div class="SystemBasic">
    ...
    <div>
      ...
      <div class="support">
        <h3>沙箱介绍</h3>
        <div>
          <div class="support-img"><img :src="$img.zhirongLogo" alt=""></div>
      ...
      <div class="state">
        ...
        <div>
          <table>
            <tr>
              <td><div>恶意样本总数：</div>{{RunState.test_times}}</td>
            ...
            <tr>
              ...
              <td><div>基因总数：</div>{{RunState.gene_num}}</td>
            </tr>
          </table>
...
<style scoped='scoped'>
  ...
  .systemLine /deep/ .line .lineTop ul li {
    background: none;
  }
</style>
