<template>
  <div
    ...
    :style="{position: userClass !== '1' && userClass !== '2' ? 'fixed' : 'static'}">
    <div class="sideBar-container">
      ...
      <el-menu
        ...
        <el-menu-item index="/EventLog">事件记录</el-menu-item>
      </el-menu>
      <!-- 普通用户侧边栏 -->
      <el-menu
        ...
        <el-submenu index="4">
          ...
          <el-menu-item index="/GeneContrast">聚类图分析</el-menu-item>
          <el-menu-item index="/GeneModel">模型管理</el-menu-item>
        </el-submenu>
        <el-submenu index="5">
          <span slot="title">流量检测</span>
          <el-menu-item index="/AlarmInfor">告警信息</el-menu-item>
          <el-menu-item index="/StatisticsRecord">统计记录</el-menu-item>
        </el-submenu>
      </el-menu>
      <button
        v-if="userClass !== '1' && userClass !== '2'"
      ...
      <div class="logout-con">
        ...
        <br>
        <section class="auto-hide" v-if="userClass !== '1' && userClass !== '2'">
          <label>自动收起</label>
          <el-switch
            v-model="autoHide"
            active-color="#9ab3ec"
