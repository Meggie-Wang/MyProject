...
if (Vue.config.productionTip) {
  apiPath = 'http://taishi.roarpanda.com:58003/'
} else {
...
localStorage.setItem('tokenName', 'cncert')
...
const apiArr = {
  ...
  'malicious_amount': 'api/malicious_amount/', // 恶意样本总量接口
  'malicious_act': 'api/malicious_act/', // 恶意行为属性接口
