...
function attachMarkerToTest( testName ){
	...
	// 增加的dom flag
	var testFlag = marker.querySelector('#testFlag');
	marker.testFlag = testFlag;
	// ------------
	...
	marker.update = function(){
		...
		// 自定义tooltip，隐藏原tootlip
		testFlag.style.width = s + 'pt'
		testFlag.style.height = s + 'pt'
	...
	var detailText = '';
	detailText += '<span class="key">' + 'ip' + ':</span>&nbsp;' + test.ip + '<br />' +
		'<span class="key">' + '攻击来源' + ':</span>&nbsp;' + test.cn_country_name || test.time + '<br />';
