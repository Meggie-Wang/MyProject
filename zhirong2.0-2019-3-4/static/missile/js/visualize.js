...
function getVisualizedMesh( linearData, year, outcomeCategories, missileCategories ){
	...
	uniforms = {
		...
		texture:   { type: "t", value: new THREE.TextureLoader().load( "images/linePoint.png" ) },
	};
...
function selectVisualization( linearData, year, tests, outcomeCategories, missileCategories ){
	...
	*	year: 最近的一年
	* tests: 选中默认的
	* outcomeCategories: outcomeLookup 的key数组
	* missileCategories: missile的key数组
	*/ 
	// console.log(linearData, year, tests, outcomeCategories, missileCategories)
	var cName = tests[0].toUpperCase();

	// $("#hudButtons .testTextInput").val(cName);
	// console.log(selectedTest, previouslySelectedTest)
	...
	// console.log(22333243, previouslySelectedTest !== selectedTest, previouslySelectedTest, selectedTest)
