<style lang="stylus" scoped>
  * {
  ...
  .point, .pie, .wordList, .hackerList, .hackerRelation, .dynamicChart, .columnChart {
    width: 100%;
    height: 100%;
  }
  .active {
...
<template lang="html">
  <div class="dashboard">
    ...
    <div class="flex-container">
      ...
      <div class="item four" @click="clickChart('4')" style="transform: translate(0%,37.5%) scale(0.33)">
        <hackerRelation :styleActive="isItemActive[3] ? activeStyle : deactiveStyle" :winResize="winResize"></hackerRelation>
      </div>
      <div class="item five" @click="clickChart('5')" style="transform: translate(33.5%,37.5%) scale(0.33)">
        <dynamicChart :styleActive="isItemActive[4] ? activeStyle : deactiveStyle" :winResize="winResize"/>
      </div>
      <div class="item six" @click="clickChart('6')" style="transform: translate(67%,37.5%) scale(0.33)">
        <column :styleActive="isItemActive[5] ? activeStyle : deactiveStyle" :winResize="winResize"></column>
      </div>
      <div class="item seven active" @click="clickChart('7')" style="transform: translate(32.9%, 2%) scale(0.99);">
...
import hackerRelation from 'components/home/hackerRelation'
