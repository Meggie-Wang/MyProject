  ...
  <div class="detection">
    ...
    <div class="detection_file">
      <div class="upload">
        ...
        <!-- <p>{{ $t('messages.geneDetection.geneDetTipone') }}<router-link to='/register'>{{ $t('messages.geneDetection.geneDetTiptwo') }}</router-link>{{ $t('messages.geneDetection.geneDetTipthree') }}</p> -->
