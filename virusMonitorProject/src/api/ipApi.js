...
export default {
  ...
  */
  column () {
    return axios.get(requestUrl + 'api/dashboard/column/')
  },
  /**
   * 大屏数据更新态势
  */
  dynamicChart () {
    return axios.get(requestUrl + 'api/realtimedata/')
  },
  /**
   * 大屏热点分析
  */
  ...
  */
   ...
   * 漏洞信息
  */
  getInforLoophole (choice = null, page = null, id = null, search = '') {
    // 搜索
   ...
   * 漏洞信息英文
  */
  getInforLoopholeEn (choice = null, page = null, id = null, search = '') {
    // 搜索
    if (choice && page && search) {
